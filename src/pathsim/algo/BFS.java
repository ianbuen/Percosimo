...
//              }              
//              
//              if(map.tileAt(p.x-1, p.y) != null && !map.tileAt(p.x-1, p.y).marked() && map.tileAt(p.x-1, p.y).passable()) {
//                 tileList.add(map.tileAt(p.x-1, p.y));
//                 map.tileAt(p.x-1, p.y).mark();
//              }
//              
...
//              }
//              
//              if(map.tileAt(p.x, p.y-1) != null && !map.tileAt(p.x, p.y-1).marked() && map.tileAt(p.x, p.y-1).passable()) {
//                 tileList.add(map.tileAt(p.x, p.y-1));
//                 map.tileAt(p.x, p.y-1).mark();
//              }
//              
